-- M1 做题模块接入 AI 记忆服务所需的最小共享表。
-- IF NOT EXISTS 允许该模块连接已经由 M6 初始化过的共享数据库。
...
(
    ...
    reminder_type  VARCHAR(50)  NOT NULL DEFAULT 'REVIEW' COMMENT '提醒类型',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='事件采集表';
